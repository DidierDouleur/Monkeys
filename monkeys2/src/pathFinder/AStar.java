...
//
//    /**
//     * Cout horizontal et vertical des mouvements.
//     */
//    private static final int V_H_COST = 1;
//
//    /**
//     * Node de notre grille.
//     */
//    private Node[][] grid;
//
//    /**
//     * On définit une PriorityQueue de nos Node ouvert. Node ouvert : Le jeu de Node qui doivent
//     * être evalues, on y met les Node au cout les plus faible en premiers.
//     */
//    private PriorityQueue<Node> openNode;
//
//    /**
//     * Node fermé : Le jeu de Node déjà évalués.
//     */
...
//        this.closedNode = new boolean[width][height];
//        this.openNode = new PriorityQueue<Node>((Node n1, Node n2) -> {
